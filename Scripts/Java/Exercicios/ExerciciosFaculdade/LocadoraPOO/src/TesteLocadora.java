...
public class TesteLocadora {
	...
	@Test
	public void testeInserirVeiculo() throws VeiculoJaCadastrado {
	...
	@Test
	public void testeInserirCliente() throws ClienteJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
	...
	@Test
	public void testePesquisarVeiculo() throws VeiculoJaCadastrado, VeiculoNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
	...
	@Test
	public void testePesquisarMoto() throws VeiculoJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
	...
	@Test
	public void testePesquisarCarro() throws VeiculoJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
	...
	@Test
	public void testePesquisarCaminhao() throws VeiculoJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
	...
	@Test
	public void testePesquisarOnibus() throws VeiculoJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
	...
	@Test
	public void testeCalcularAluguel() throws VeiculoJaCadastrado, VeiculoNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
	...
	@Test
	public void testeRegistrarAluguel() throws VeiculoNaoCadastrado, VeiculoAlugado, ClienteNaoCadastrado, VeiculoJaCadastrado, ClienteJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Cliente cli1 = new Cliente("Zé Carlos", 1234);
		locadora.inserir(carro1);
	...
	@Test
	public void testeRegistrarDevolucao() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado, VeiculoAlugado, ClienteNaoCadastrado, VeiculoNaoAlugado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Cliente cli1 = new Cliente("Zé Carlos", 1234);
		locadora.inserir(carro1);
	...
	@Test
	public void testeDepreciarVeiculos() throws VeiculoJaCadastrado, VeiculoNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Veiculo caminhao1 = new Caminhao("Estrela", "Betelgeuse", 1975, "S-123", 70, 30000, 200);
	...
	@Test
	public void testeAumentarDiaria() throws VeiculoJaCadastrado, VeiculoNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Veiculo caminhao1 = new Caminhao("Estrela", "Betelgeuse", 1975, "S-123", 70, 30000, 200);
		...
		System.out.println("Valor caminhao" + locadora.pesquisar("S-123").getValorDiaria());
	...
	@Test
	public void testeFaturamentoTotal() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado, VeiculoAlugado, ClienteNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Veiculo caminhao1 = new Caminhao("Estrela", "Betelgeuse", 1975, "S-123", 70, 30000, 200);
	...
	@Test
	public void testeQuantidadeTotalDeDiarias() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado, VeiculoAlugado, ClienteNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Veiculo caminhao1 = new Caminhao("Estrela", "Betelgeuse", 1975, "S-123", 70, 30000, 200);
